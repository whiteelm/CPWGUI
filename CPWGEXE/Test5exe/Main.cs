...
namespace Test5exe
{
    ...
    {
        [DllImport(@"CPWG.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CPWG")]
        private static extern void CPWG(double t, double h, double er, double aw, double[] s,
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            CPWG(t, h, er, aw, s, ref dC, ref dL, ref em, ref dZ0);
